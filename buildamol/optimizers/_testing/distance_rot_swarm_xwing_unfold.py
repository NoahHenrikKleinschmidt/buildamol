...
# export name prefix
export_name_prefix = "xwing_unfold_genetic_no_early_stop_"


# graph building function
# provide a custom callable that generates a tuple of (graph, rotatable_edges
def make_graph(x: bam.Molecule):
    g = x._AtomGraph
    edges = g.find_rotatable_edges(min_descendants=20, min_ancestors=20)
    edges = g.direct_edges(x.get_atom("Cl1"), edges)
    return g, edges
