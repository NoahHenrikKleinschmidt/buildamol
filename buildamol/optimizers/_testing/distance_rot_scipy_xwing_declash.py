...
# export name prefix
export_name_prefix = "xwing_declash_scipy_"
...
def make_graph(x):
    ...
    # g.add_edges_from((e[1], e[1].parent) for e in edges)
    # g.add_edges_from((e[0], e[0].parent) for e in edges)
    return g, edges
