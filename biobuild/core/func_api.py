...
def export_custom_resources(directory_name: str):
    ...
    """
    resources.export_compounds(directory_name + "/pdbe_compounds.json")
    resources.export_topology(directory_name + "/charmm_topology.json")
...
def import_custom_resources(directory_name: str, overwrite: bool = False):
    ...
    """
    compounds = resources.read_compounds(directory_name + "/pdbe_compounds.json")
    topology = resources.read_topology(directory_name + "/charmm_topology.json")
    if overwrite:
        resources.set_default_compounds(compounds, overwrite=True)
        resources.set_default_topology(topology, overwrite=True)
